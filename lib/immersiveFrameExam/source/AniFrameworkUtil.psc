scriptname AniFrameworkUtil hidden
...
string function GetStringVer() global
	return "Immersive Animation Framework"
endFunction
...
ObjectReference function FindBed(ObjectReference CenterRef, float Radius = 1000.0, bool IgnoreUsed = true, ObjectReference IgnoreRef1 = none, ObjectReference IgnoreRef2 = none) global
...
bool function IsImportantActor(Actor ActorRef, bool Strict = false) global
