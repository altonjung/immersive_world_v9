scriptname ImmersiveAnimalFarmChick extends Actor
...
Event OnUpdateGameTime()
    ...
    if _weatherType != 2
        ...
        if _currentHour > 6.0 && _currentHour < 7.0
            RegisterForSingleUpdateGameTime(0.5)
        elseif _currentHour >= 7.0 && _currentHour <= 19.0
            SoundCoolTimePlay(SayAnimalChickCrySound)
            RegisterForSingleUpdateGameTime(0.1)
        else
...
Sound property SayAnimalChickCrySound Auto