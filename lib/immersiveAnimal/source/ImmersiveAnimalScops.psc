scriptname ImmersiveAnimalScops extends Actor
...
Event OnUpdateGameTime()
    ...
    if _weatherType != 2
        ...
        if _currentHour > 18.0 && _currentHour < 20.0
            RegisterForSingleUpdateGameTime(0.5)
        elseif _currentHour >= 20.0 || _currentHour <= 5.0
            RegisterForSingleUpdateGameTime(Utility.RandomFloat(0.1, 0.2))
            SoundCoolTimePlay(SayAnimalScopsHootSound)
        else
...
Sound property SayAnimalScopsHootSound Auto