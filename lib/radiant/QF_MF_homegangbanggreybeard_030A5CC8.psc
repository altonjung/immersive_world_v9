...
Scriptname QF_MF_homegangbanggreybeard_030A5CC8 Extends Quest Hidden
...
Function Fragment_5()
;BEGIN AUTOCAST TYPE mf_homegangbangGreybeardscript
Quest __temp = self as Quest
mf_homegangbangGreybeardscript kmyQuest = __temp as mf_homegangbangGreybeardscript
;END AUTOCAST
;BEGIN CODE
(Alias_theMainClient.GetReference() as Actor).EvaluatePackage()
