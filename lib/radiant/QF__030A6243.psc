...
Scriptname QF__030A6243 Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE mf_RPG_MythicDawnscript
Quest __temp = self as Quest
mf_RPG_MythicDawnscript kmyQuest = __temp as mf_RPG_MythicDawnscript
;END AUTOCAST
;BEGIN CODE
