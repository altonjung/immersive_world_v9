Scriptname mf_HomeJobQuestScript extends MF_RandomQuest
...
mf_HomeJobConditional Property QuestConditional Auto
...
Function AllowEntry()
    ...
    handler.setGuestOrgasmActor(akGuestRef.GetRef() as Actor)
    handler.StripExposure(akGuestRef.GetRef() as Actor, 25)
endFunction
...
Function PerformScene1()
    ...
    elseif(QuestConditional.Scene1Type == 3); do try out
        ...
        variables.GuestOrgasmActor = akGuestRef.GetActorReference()
        doForeplay=true
