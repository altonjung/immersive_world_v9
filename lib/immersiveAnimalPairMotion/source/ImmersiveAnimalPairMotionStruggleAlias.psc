scriptname ImmersiveAnimalPairMotionStruggleAlias extends ReferenceAlias
...
function regAnimation ()	
	;
	RegisterForModEvent("ImpPairMotionForStruggle", 	"processStruggleScene")		
endFunction
...
Event OnUpdate()	
	; 10% health 감소
	float _healthValue = playerRef.GetActorValuePercentage("Health")		
	_actor.DamageActorValue("Health", _healthValue - 10.0)
